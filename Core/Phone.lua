-- ================================================
-- PHONE GUI - Complete with Lifecycle Management
-- ================================================
...
sa.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
...
addCleanup(function()
    pcall(function() task.cancel(clockTask) end)
end)
...
homeWall.BackgroundColor3 = Color3.fromRGB(20, 20, 28)
homeWall.ZIndex = 0
corner(homeWall, 30)
...
dockBg.BackgroundColor3 = Color3.fromRGB(30, 30, 40)
dockBg.BackgroundTransparency = 0.3
corner(dockBg, 20)
...
appGrid.ScrollBarImageColor3 = Color3.fromRGB(255, 255, 255)
...
-- Online heartbeat with cleanup
local heartbeatTask = task.spawn(function()
...
addCleanup(function()
    pcall(function() task.cancel(heartbeatTask) end)
