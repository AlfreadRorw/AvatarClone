-- ================================================
-- APPLICATIONS/TELEPORT.LUA — Premium Monochrome Teleport App
...
local LIGHT_GRAY = Color3.fromRGB(245, 245, 250)
local MID_GRAY = Color3.fromRGB(200, 200, 210)
local DARK_GRAY = Color3.fromRGB(100, 100, 110)
local ACCENT = Color3.fromRGB(30, 30, 40)
...
local function createSearchBar(parent)
    ...
    Helpers.corner(searchFrame, 12)
    Helpers.stroke(searchFrame, ACCENT, 1, 0.3)
...
local function createFilterTabs(parent)
    ...
    for i, tab in ipairs(tabs) do
        ...
        Helpers.stroke(btn, ACCENT, 1, 0.5)
...
local function createPlayerCard(parent, player, order)
    ...
    Helpers.stroke(card, ACCENT, 1, 0.3)
    ...
    Helpers.stroke(avatarWrap, ACCENT, 1, 0.3)
    ...
    spectateBtn.Text = "👁"
    spectateBtn.TextColor3 = BLACK
    spectateBtn.Font = Enum.Font.GothamBold
    spectateBtn.TextSize = 16
    spectateBtn.AutoButtonColor = false
    Helpers.corner(spectateBtn, 8)
    Helpers.stroke(spectateBtn, ACCENT, 1, 0.5)
    ...
    spectateBtn.MouseButton1Click:Connect(function()
        if isSpectating and selectedPlayer == player then
            ...
            spectateBtn.BackgroundColor3 = GREEN
...
function _G.openTeleportApp()
    ...
    elseif currentFilter == "history" then
        ...
        for _, historyItem in ipairs(teleportHistory) do
            ...
            Helpers.corner(historyCard, 12)
            Helpers.stroke(historyCard, ACCENT, 1, 0.3)
...
print("[Teleport] Premium Monochrome Teleport App Loaded!")